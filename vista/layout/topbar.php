...
<head>
    ...
    <head lang="es">
        ...
        <script src="https://kit.fontawesome.com/82bdc198fe.js" crossorigin="anonymous"></script>
                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h5 class="p-2 text-center bg-primary"><?= $_SESSION["nombre1"]." ". $_SESSION["apellido1"]?></h5>
